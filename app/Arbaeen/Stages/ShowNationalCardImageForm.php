...
class ShowNationalCardImageForm extends Base
{
    ...
    {
        $this->sendMessage(__('telegram.messages.show_national_card_image_form'));
    }

    protected function done()
    {
        $this->setStage(GetNationalCardImage::class);
    }
}
